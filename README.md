...
- [ ] Explain the difference between `Relational Databases` and `SQL`. One is a software the other is a language.

- [ ] Why do tables need a `primary key`?
The primary key is that id value. You need it to be able to access all the elements of the table.
